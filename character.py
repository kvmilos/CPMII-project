...
import pymunk
import math
from simulation import ROBOT_COLLISION_TYPE

class Robot():
    # robot is a circle with a vision field
    def __init__(self, name, space, collision_type, position = (100, 100), size = 30, angle = 0, color = (50, 50, 200, 100), vision_field_angle = 90, vision_field_range = 150):
        self.name = name
    ...
    def draw(self, window = None):
        ...
        # pygame.draw.arc(window, (50, 200, 150), rect, 0, math.pi * 2, 1)
